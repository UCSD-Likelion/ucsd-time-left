...
export default function WriteLetterPage() {
  ...
  // NOTE: Auth redirect disabled for design preview.
  // Re-enable this when you want to require login on the compose page.
  // useEffect(() => {
        ...
        <div className={styles.ComposeGrid}>
          <div className={styles.ComposeCard}>
            <div className={styles.ComposeHeader}>
              ...
              <div className={styles.SmallHint}>Design preview (auth disabled)</div>
            </div>
            ...
            <div className={styles.ActionRow}>
              ...
              <button
                ...
                onClick={submit}
                disabled={busy || !toUser.trim() || !content.trim()}
                style={busy || !toUser.trim() || !content.trim() ? { opacity: 0.6, cursor: "not-allowed" } : undefined}
              >
                {busy ? "Sending..." : "Send"}
              </button>
            </div>
